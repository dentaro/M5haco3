...
//24bitRGB
  ...
  // void fill3DFastTriangle(int32_t x0, int32_t y0, int32_t x1, int32_t y1, int32_t x2, int32_t y2, uint16_t c1);
  // void fastPoint(const Vector3<float> v1, uint16_t c1);
  void fastPoint(const Vector3<float> v1, int starbrightness, int noInt);

  void fill3DFastTriangle(int32_t x0, int32_t y0, int32_t z0,int32_t x1, int32_t y1, int32_t z1,int32_t x2, int32_t y2, int32_t z2,uint16_t c1);
