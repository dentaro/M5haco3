...
// void RunHaco8Game::fill3DFastTriangle(int32_t x0, int32_t y0, int32_t x1, int32_t y1, int32_t x2, int32_t y2, uint16_t c1){
  void RunHaco8Game::fill3DFastTriangle(int32_t x0, int32_t y0, int32_t z0,
...
//   fastPoint(static_cast<int32_t>(v1.getX()),
//             static_cast<int32_t>(v1.getY()),
//             static_cast<int32_t>(v1.getZ()),c1);
// }
...
// Vector3<float> op[numVertices];
// Vector3<float> p[numVertices];
...
int RunHaco8Game::l_creobj(lua_State* L) {
    ...
    //     op[k].setX(sin(i*cdeg*RAD_ONE) * r);
    //     op[k].setZ(cos(i*cdeg*RAD_ONE) * r);
    //     op[k].setY(y);
    //   }
    // }
